const biomarkerReference = {
  ...
  // 🫀 AVF — Arterio-Vascular
  TotalCholesterol: { mean: 190, sd: 30, direction: "high_worse", domain: "AVF", unit: "mg/dL" },
  LDL: { mean: 100, sd: 30, direction: "high_worse", domain: "AVF", unit: "mg/dL" },
  HDL: { mean: 55, sd: 15, direction: "low_worse", domain: "AVF", unit: "mg/dL" },
  Triglycerides: { mean: 130, sd: 40, direction: "high_worse", domain: "AVF", unit: "mg/dL" },
  VEGF: { mean: 200, sd: 80, direction: "low_worse", domain: "AVF", unit: "pg/mL" },
  ...
  TGFb1: { mean: 10, sd: 5, direction: "high_worse", domain: "PNF", unit: "ng/mL" },
